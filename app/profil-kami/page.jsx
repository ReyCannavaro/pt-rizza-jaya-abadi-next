...
const nilaiPerusahaan = [
  {
    judul: 'Kepercayaan',
    deskripsi: 'Kami membangun setiap hubungan dengan kejujuran. Apa yang kami janjikan adalah apa yang kami berikan.',
  },
  {
    judul: 'Profesionalisme',
    deskripsi: 'Setiap detail perjalanan kami tangani dengan standar kerja yang terstruktur dan tim yang berpengalaman.',
  },
  {
    judul: 'Kepedulian',
    deskripsi: 'Pelanggan bukan sekadar klien. Kami memastikan setiap orang merasa diperhatikan sepanjang perjalanan.',
  },
  {
    judul: 'Keandalan',
    deskripsi: 'Tepat waktu, tanggap, dan selalu siap. Kami hadir ketika Anda membutuhkan kami.',
  },
];
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32 }}>
            ...
            <div style={{ background: '#ffffff', border: '1px solid #e2e8f0', borderRadius: 20, padding: '44px 40px' }}>
              <div style={{
                display: 'inline-block',
                background: '#eef4fb', borderRadius: 8,
      ...
      <section style={{ padding: '80px', background: '#0f3460' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 52 }}>
            <p style={{ fontSize: 12, fontWeight: 500, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#e8a020', marginBottom: 14 }}>
              Dalam Angka
            </p>
